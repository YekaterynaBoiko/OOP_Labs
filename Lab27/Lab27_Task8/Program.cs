namespace Lab27_Task8
{
    public class Program
    {
        ...
        public void AddProductToBasket(Shop shop, Basket basket)
        {
            Console.WriteLine("Введіть назву продукту для пошуку: ");
            string name = Console.ReadLine();
            Product found = shop.GetProduct(name); 
        ...
        static void Main(string[] args) 
        {
            ...
            shop.AddProduct(new Product { Name = "Томат", Price = 20.40, Description = "кг", Amount = 1.0 });
            ...
            while (true)
            {
                Console.WriteLine("\n1 Додати товар " +
                    ...
                    "\n5 Асортимент магазину " +
                    "\n6 Сортувати кошик " +
                    "\n0 Вийти");
                Console.WriteLine();
                Console.WriteLine("Введіть значення від 0 до 6");
                ...
                switch (choice)
                {
                    ...
                    case "5":
                        shop.ShowProducts(); break;
                    case "6":
                        basket.SortByName(); break;
                    case "0":
                        return;
                    default:
